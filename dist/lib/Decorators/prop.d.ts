...
/** @internal */
export declare function getSecondaryKey(target: any): string | undefined;
/** @internal */
export declare function getCreatedAtKey(target: any): string | undefined;
/** @internal */
export declare function getUpdatedAtKey(target: any): string | undefined;
/** @internal */
export declare function setPropDescriptor(target: any, propertyKey: string): void;
/** @internal */
export declare function setPropGettersAndSetters(target: any, propertyKey: string): void;
/**
 ...
 */
export declare function prop(opts?: PropOptions): (target: any, propertyKey: string) => void;
