...
describe('Entity creation', () => {
    it('creates basic entity w/ defaults', () => __awaiter(void 0, void 0, void 0, function* () {
        // Create entity
    ...
    it('creates basic entity w/o timestamps', () => {
        let TestEntity = new Entity_1.default({
            name: 'TestEntity',
            timestamps: false,
            attributes: {
                pk: { partitionKey: true }
    ...
    it('fails when creating a entity without a partitionKey', () => {
        let result = () => new Entity_1.default({
            name: 'TestEntity',
            attributes: {}
        });
    ...
    it(`fails when providing an invalid entity definition`, () => {
        // @ts-expect-error
        let result = () => new Entity_1.default('test');
        expect(result).toThrow(`Please provide a valid entity definition`);
    });
